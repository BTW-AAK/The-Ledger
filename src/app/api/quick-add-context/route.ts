...
export async function GET() {
  ...
  const [accounts, categories, templates, merchantMemory, { homeCurrency }] = await Promise.all([
  ...
  return NextResponse.json({ accounts, categories, templates, merchantMemory, homeCurrency });
}
